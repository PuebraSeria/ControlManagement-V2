...
<asp:Content ID="Content4" ContentPlaceHolderID="Body" runat="server">
            ...
            <div class="panel-body" style="max-height:400px; overflow: scroll;">
                <div class="timeline">
                  ...
                  <ul class="timeline-items">
                    <li class="timeline-item"> <!-- Normal block, positionned to the left -->
                      <h3>Title</h3>
                      <hr>
                  ...
                  <h2>2014</h2>
                  <ul class="timeline-items">
                    <li class="timeline-item inverted"> <!-- Normal block, positionned to the right  -->
                      <h3>Title</h3>
                      <hr>
                  ...
                  <ul class="timeline-items">
                    ...
                    <li class="timeline-item centered">
                      <h3>Title</h3>
                      <hr>
    ...
    <script src="../DESARROLLO/Simple-Animated-Timeline-Plugin-For-jQuery-Timelify/js/jquery.timelify.js"></script>
