<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/frm_SPV_MasterPageSupervisor.Master" CodeBehind="frm_SPV_Crear_Periodo.aspx.vb" Inherits="GCA.SPV.UserInterface.frm_Crear_Periodo" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Body" runat="server">
    <table style="width: 100%;">
                       ...
                       <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label runat="server" Text="txtDias:"></asp:Label>
                                <br />
